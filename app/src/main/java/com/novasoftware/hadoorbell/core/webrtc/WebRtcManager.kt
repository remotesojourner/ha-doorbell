...
class WebRtcManager(
    ...
    fun startConnection(videoSink: VideoSink, enableMicrophone: Boolean, onError: (String) -> Unit) {
        ...
        connectionJob = coroutineScope.launch {
            try {
                ...
                peerConnection = peerConnectionFactory!!.createPeerConnection(rtcConfig, object : PeerConnection.Observer {
                    ...
                    override fun onAddTrack(receiver: RtpReceiver?, mediaStreams: Array<out MediaStream>?) {
                        ...
                        if (track is VideoTrack) {
                            ...
                            audioDeviceManager.reevaluateAudioDevice()
                        }
                    }
                })
                ...
                kotlinx.coroutines.withTimeoutOrNull(ICE_GATHERING_TIMEOUT_MS) {
    ...
    // AudioDeviceManager handles optimal audio device settings
}
